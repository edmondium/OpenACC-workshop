...
!$acc parallel loop reduction(max:error)
  do j = 2, NM-1
!! TODO: Refactor the following inner part of the core double-loop into a dedicated sub-routine called inner_loop (see end of file)
    do i = 2, NN-1
...
contains
!! TODO: Refactor the inner loop of the core double-loop into a dedicated subroutine; make the loop also parallel!
!! Hints
!!    * You need to make the subroutine a OpenACC Routine
!!    * It is sufficient to make inner_loop get A, Anew, j, and error as inputs
